...
export interface IIdenityCheckTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IIdenityCheckTabRemoveProps {

}

/**
 * Implementation of Idenity Check remove page
 */
export class IdenityCheckTabRemove  extends TeamsBaseComponent<IIdenityCheckTabRemoveProps, IIdenityCheckTabRemoveState> {
